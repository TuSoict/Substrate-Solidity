...
function App () {
  ...
  const addRskTestnet = () =>
    addNetwork([
      {
        chainId: '0x501',
        chainName: 'Horizonland Testnet',
        nativeCurrency: {
          name: 'Test Hor',
          symbol: 'tRBTC',
          decimals: 18
        },
        rpcUrls: ['https://bitter-glasses-do-13-214-176-133.loca.lt'],
        blockExplorerUrls: ['https://bitter-glasses-do-13-214-176-133.loca.lt/']
      }
    ])
  ...
  return (
    <div className="App">
      <header className="App-header">
        Add Testnet and Mainnet OCT to Metamask.
      </header>
      ...
      <section>
        ...
        <button onClick={addRskMainnet}>Add OCT Mainnet</button>
        <button onClick={addRskTestnet}>Add OCT Testnet</button>
      </section>
